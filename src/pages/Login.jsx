    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4 font-sans">
      <div className="w-full max-w-md bg-white p-8 md:p-12 rounded-[2rem] shadow-2xl">
        <div className="text-left">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Sing in</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-sm font-medium text-gray-400 hover:text-gray-900">Forgot Password ?</a>
              </div>
              <input
                id="password"
                name="password"
          ...
          <div className="mt-8 text-center text-sm">
            ...
            {/* <a href="#" className="font-medium text-red-500 hover:text-red-600">Sign up</a> */}
              ...
              onClick={(e) => {
                ...
                setIsLogin(false); // Set state to show the SignUp component
              }}
            >
              Sign up
            </a>
